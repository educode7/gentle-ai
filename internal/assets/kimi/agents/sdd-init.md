...
description: >
  ...
  "iniciar sdd", or wants to bootstrap SDD persistence for the first time in a project.
model: inherit
readonly: false
background: false
---
...
Read the skill file at `~/.config/agents/skills/sdd-init/SKILL.md` and follow it exactly.
